...
class User extends Model implements IdentityInterface, AclUserInterface
{
    ...
    public function getIdField()
    {
        ...
        // Then you can use a calculated column with a UUID generated by FW\Utils\UUID::random();
    ...
    public function getPermissionFor($aclObjectName)
    {
        foreach ($this->permissions as $permission) {
            if (preg_match('/'.$permission.'/', FW\URI::requestMethod().'|'.$aclObjectName)) {
                return true;
            }
        }
    ...
    protected function triggerBeforeInsert()
    {
        ...
        $validation = FW\Validation\Validator::make(
            ['dk' => null],
            ['dk' => 'Required'],
