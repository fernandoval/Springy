...
class Kernel {
	...
	public static function print_copyright() {
		...
		echo 'Smarty: the PHP compiling template engine v3.0.7 (c) 2008 New Digital Group, Inc.<br />';
