...
class OS {
    ...
    /**
     *  \brief Return the name of the OS.
     *
     *  @return  string
     */
    ...
    /**
     *  \brief Return the version of the OS.
     *
     *  @return  string
     */
    ...
    /**
     *  \brief Set the version of the OS.
     *
     *  @param   string $value
     *  @return  void
     */
    ...
    /**
     *  \brief Is the browser from a mobile device?
     *
     *  @return  bool
     */
    ...
    /**
     *  \brief Set the Browser to be mobile
     *
     *  @param   bool $value
     *  @return  void
     */
    ...
    /**
     *  \brief Determine the user's operating system
     *
     *  @return  bool
     */
    ...
    /**
     *  \brief Determine if the user's browser is on a mobile device.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is iOS.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is OS X.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is SymbOS.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is Linux.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is Nokia.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is BlackBerry.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is Android.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is FreeBSD.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is OpenBSD.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is SunOS.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is NetBSD.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is OpenSolaris.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is OS2.
     *
     *  @return   bool
     */
    ...
    /**
     *  \brief Determine if the user's operating system is BeOS.
     *
     *  @return   bool
     */
