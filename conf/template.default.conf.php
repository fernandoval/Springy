...
$conf = [
    ...
    'optimizations'          => 1,
    'debugging_ctrl'         => 'NONE',
    'default_template_path'  => sysconf('SYSTEM_PATH').DIRECTORY_SEPARATOR.'templates_default',
    'template_path'          => sysconf('SYSTEM_PATH').DIRECTORY_SEPARATOR.'templates',
    'template_config_path'   => sysconf('SYSTEM_PATH').DIRECTORY_SEPARATOR.'templates_conf',
    'compiled_template_path' => sysconf('PATH_VAR').DIRECTORY_SEPARATOR.'compiled',
    'template_cached_path'   => sysconf('PATH_VAR').DIRECTORY_SEPARATOR.'cache',
    'use_sub_dirs'           => false,
    'errors'                 => [
        404 => '_error404',
        500 => '_error500',
